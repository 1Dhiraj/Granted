  ...
  return html`
    ...
    >
      ...
      <div class="agent-chat__input">
        ...
        ${(vs.sttRecording && vs.sttInterimText) || getTalkInterim()
          ? html`<div class="agent-chat__stt-interim">
              ${getTalkInterim() || vs.sttInterimText}
            </div>`
          : nothing}
        ...
        <textarea
          ...
          placeholder=${getTalkPhase() !== "off"
            ? {
                listening: "Talk mode — listening...",
                thinking: "Talk mode — thinking...",
                speaking: "Talk mode — speaking (click the talk button to interrupt)",
                off: placeholder,
              }[getTalkPhase()]
            : vs.sttRecording
              ? "Listening..."
        ...
        <div class="agent-chat__toolbar">
          <div class="agent-chat__toolbar-left">
            ...
            ${isTalkSupported()
              ? html`
                  <button
                    class="agent-chat__input-btn agent-chat__talk-btn agent-chat__talk-btn--${getTalkPhase()}"
                    @click=${() => {
                      const phase = getTalkPhase();
                      if (phase === "off") {
                        startTalk({
                    ...
                    title=${{
                      off: "Start talk mode (voice conversation)",
                      listening: "Talk mode: listening — click to stop",
                      thinking: "Talk mode: waiting for reply — click to stop",
                      speaking: "Talk mode: speaking — click to interrupt",
                    }[getTalkPhase()]}
