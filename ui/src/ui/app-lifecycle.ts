...
import {
  startAgentsActivityPolling,
  startLogsPolling,
  startNodesPolling,
  stopAgentsActivityPolling,
  stopLogsPolling,
  stopNodesPolling,
  startDebugPolling,
  stopDebugPolling,
...
export function handleConnected(host: LifecycleHost) {
  ...
  startAgentsActivityPolling(host as unknown as Parameters<typeof startAgentsActivityPolling>[0]);
  if (host.tab === "logs") {
...
export function handleDisconnected(host: LifecycleHost) {
  ...
  stopAgentsActivityPolling(host as unknown as Parameters<typeof stopAgentsActivityPolling>[0]);
