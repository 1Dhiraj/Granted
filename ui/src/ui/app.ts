...
export class OpenClawApp extends LitElement {
  ...
  @state() providersList: import("./views/providers.ts").ProviderItem[] = [];
  @state() providersError: string | null = null;
  @state() providersEdits: Record<string, string> = {};
  @state() providersOpenId: string | null = null;
  @state() providersSavingId: string | null = null;
  @state() providersMessages: Record<string, { kind: "success" | "error"; text: string }> = {};
  @state() ollamaModels: import("./views/providers.ts").OllamaModel[] | null = null;
