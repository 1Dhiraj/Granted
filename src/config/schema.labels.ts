...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.fs.allowPaths": "Extra Allowed FS Paths",
  ...
  "agents.defaults.spendLimitUsdByProvider": "Per-Provider Spend Limits (USD)",
  "agents.defaults.economyModel": "Economy Model (Background Roles)",
  ...
  "auth.cooldowns.fallbackOnRateLimit": "Fallback Models on Rate Limit",
