...
export function resolveEffectiveModelFallbacks(params: {
  ...
  // User explicitly selected a model — do not silently fall back to another.
  // Only use an agent-specific fallback list if one was explicitly configured;
  // never pull in the global default chain when the user made an explicit choice.
  return agentFallbacksOverride ?? [];
}
