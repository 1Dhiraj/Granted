...
const BRAND_ASCII = [
  ...
  "██   ██  ██   ██ ██   ██ ██  ██ ██    ██    ██      ██   ██",
  " ██████  ██   ██ ██   ██ ██   ████    ██    ███████ ██████ ",
  "            GRANTED — your AI, your keys, your machine",
  " ",
];
...
export function formatCliBannerArt(options: BannerOptions = {}): string {
  ...
  const colored = BRAND_ASCII.map((line) => {
    if (line.includes("GRANTED")) {
      return theme.muted("            ") + theme.info("GRANTED — your AI, your keys, your machine");
    }
